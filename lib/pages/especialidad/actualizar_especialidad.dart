...
class ActualizarEspecialidades extends StatefulWidget {
  const ActualizarEspecialidades({Key? key, this.index}) : super(key: key);
  final dynamic index;
  //1 : Adicionar
  //2 : Actualizar

  @override
  State<ActualizarEspecialidades> createState() =>
      _ActualizarEspecialidadesState();
}

class _ActualizarEspecialidadesState extends State<ActualizarEspecialidades> {
